...
export const COMPRESSION_FACTORS: Record<CompressionLevel, CompressionFactors> = {
  low: {
    jpegQuality: 0.92,        // Alta calidad de imagen JPEG (0-1)
  ...
  medium: {
    jpegQuality: 0.65,        // Calidad media para balance
    ...
    imageQuality: 0.70,       // Calidad media para imágenes
    preserveTextQuality: true // Aún se preserva texto
  },
  high: {
    jpegQuality: 0.35,        // Baja calidad para máxima compresión
    scaleFactor: 0.60,        // Reducción sustancial
    ...
    imageQuality: 0.40,       // Baja calidad para imágenes
...
export const MIN_SIZE_REDUCTION = {
  low: 0.001,   // Al menos 0.1% de reducción para nivel bajo (mínimo para asegurar éxito)
