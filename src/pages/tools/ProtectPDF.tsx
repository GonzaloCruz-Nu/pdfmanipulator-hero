      ...
      <div className="container py-12 max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Añade contraseñas a tus documentos PDF para protegerlos de accesos no autorizados
          </p>
        </div>
        ...
        <Card className="border-amber-200 dark:border-amber-800 shadow-sm">
          <CardContent className="p-6 flex flex-col items-center justify-center min-h-[300px]">
            ...
            <p className="text-muted-foreground text-center mb-6 max-w-lg">
              La herramienta para proteger PDFs está actualmente en desarrollo y no se encuentra disponible.
