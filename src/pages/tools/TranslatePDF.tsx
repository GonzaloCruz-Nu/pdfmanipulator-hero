    ...
    <Layout>
      ...
      <div className="container py-12 max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-4">Traducir PDF</h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Traduce documentos PDF del español al inglés utilizando inteligencia artificial
          </p>
        </div>
        ...
        <Card className="border-amber-200 dark:border-amber-800 shadow-sm">
          <CardContent className="p-6 flex flex-col items-center justify-center min-h-[300px]">
            ...
            <p className="text-muted-foreground text-center mb-6 max-w-lg">
              La herramienta de traducción de PDFs está actualmente en desarrollo y no se encuentra disponible.
